...
with open("/global/scratch/users/austinhpatton/cichlids/Oreochromis-Reference-2018/mask_50_50.fa", "r") as f:
  for line in f:
    if line.startswith('>'):
      chr = line.split()[0][1:]
      mask = MaskGenerator("/global/scratch/users/austinhpatton/cichlids/Oreochromis-Reference-2018/mask_50_50-{}.mask.bed.gz".format(chr), chr)
      pos = 0
      continue
    for c in line.strip():
      pos += 1
